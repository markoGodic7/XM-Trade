...
//       change.className = `card__change ${item.percent_change_24h < 0 ? 'card__change--negative' : 'card__change--positive'}`;
//       const arrow = document.createElement('i');
//       arrow.className = item.percent_change_24h < 0 ? 'fa fa-arrow-down' : 'fa fa-arrow-up';
//       change.appendChild(arrow);
//       change.insertAdjacentText('beforeend', ` ${item.percent_change_24h}%`);
...
//         change.textContent = `${item.percent_change_24h}%`;
